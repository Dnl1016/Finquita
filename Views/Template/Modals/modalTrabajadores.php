<!-- Modal -->
<div class="modal fade" id="modalFormTrabajadores" tabindex="-1" role="dialog" aria-hidden="true">
...
<!-- Modal -->
<div class="modal fade" id="modalViewTrabajadores" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" >
    <div class="modal-content">
      <div class="modal-header header-primary">
        <h5 class="modal-title" id="titleModal">Datos del trabajador</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
