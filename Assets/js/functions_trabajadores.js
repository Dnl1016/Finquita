...
document.addEventListener('DOMContentLoaded', function(){
    ...
    tablaTrabajadores = $('#tablaTrabajadores').dataTable( {
        ...
        "ajax":{
            "url": " "+base_url+"/Trabajadores/getTrabajadores",
            "dataSrc":""
        },
        "columns":[
            {"data":"idWorkers"},
	...
	if(document.querySelector("#formTrabajador")){
        ...
        formTrabajador.onsubmit = function(e) {
            ...
            let ajaxUrl = base_url+'/trabajadores/setTrabajadores'; 
            ...
            request.onreadystatechange = function(){
                if(request.readyState == 4 && request.status == 200){
                    ...
                    {
                        if(rowTable == ""){
                            tablaTrabajadores.api().ajax.reload();
                        }else{
...
function fntViewInfo(idpersona){
    let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
    let ajaxUrl = base_url+'/trabajadores/getCliente/'+idpersona;
...
function fntDelInfo(idpersona){
    swal({
        ...
        {
            let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
            let ajaxUrl = base_url+'/Trabajadores/deleteWorker';
