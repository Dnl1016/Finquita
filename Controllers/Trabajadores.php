...
class Trabajadores extends Controllers{
	...
	public function getTrabajadores()
	{
		if($_SESSION['permisosMod']['r']){
			...
			for ($i=0; $i < count($arrData); $i++) {
				...
				$btnDelete = '';
				if($_SESSION['permisosMod']['r']){
					$btnView = '<button class="btn btn-info btn-sm" onClick="fntViewInfo('.$arrData[$i]['idWorkers'].')" title="Ver Trabajador"><i class="far fa-eye"></i></button>';
				}
				if($_SESSION['permisosMod']['u']){
					$btnEdit = '<button class="btn btn-primary  btn-sm" onClick="fntEditInfo(this,'.$arrData[$i]['idWorkers'].')" title="Editar cliente"><i class="fas fa-pencil-alt"></i></button>';
				}
				if($_SESSION['permisosMod']['d']){	
					$btnDelete = '<button class="btn btn-danger btn-sm" onClick="fntDelInfo('.$arrData[$i]['idWorkers'].')" title="Eliminar cliente"><i class="far fa-trash-alt"></i></button>';
				}
